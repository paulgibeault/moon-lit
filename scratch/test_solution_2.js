...
console.log('\n--- STEP 1: Park Yellow ---');
// Let's park yellow on the far left. Cell (0, 3) or (-1, 3)
let angle1 = findAngleForCell(game, 0, 3);
...
console.log('\n--- STEP 2: Park Green ---');
// Let's park green on the far left. Cell (1, 4)
let angle2 = findAngleForCell(game, 1, 4);
