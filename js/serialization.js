...
export function serializeGame(g) {
  return {
    ...
    moonMeter: g.moonMeter || 0,
    moonriseCharges: g.moonriseCharges || 0,
    moonburstReady: !!g.moonburstReady,
...
export function restoreGame(saved) {
  ...
  return {
    ...
    moonMeter: migrated.moonMeter || 0,
    moonriseCharges: migrated.moonriseCharges | 0,
    moonburstReady: !!migrated.moonburstReady,
    moonGlow: 0,
    ...
    descentShots,
    isSpeedMode,
    // Saves only happen between shots in standard modes; restored speed mode
    // implies fast launch. Combo powers key off this via comboPowersActive.
    isFastLaunch: isSpeedMode,
